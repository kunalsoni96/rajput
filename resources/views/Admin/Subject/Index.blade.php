      ...
      <div class="card" style="min-height: 80vh">
        <div class="card-header" style="background: #262D47; height: 60px">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="{{route('Admin/Subject/Add')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
            </div>
          </div>
        </div>
            ...
            <div class="table-responsive">
                      ...
                      @foreach($data as $row)
                          <tr>
                              ...
                              <form action="{{route('Admin/Subject/EditSession')}}" method="post">
                              <td>
                                {{csrf_field()}}
