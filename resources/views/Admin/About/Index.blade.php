            ...
            <div class="col-md-12">
              <div class="card">
                  ...
                  <div style="background-color: #665C7C; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>Manage About
                      <a href="{{route('Admin/About/Add')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#665C7C;">Add New</a></h4>
                  </div>
                </div>
                <div class="card-body">
              ...
              @endif
                  ...
                  @foreach($Abouts as $row)
                        <tr>
                          <td>{{$i++}}</td>
                          <td>{{$row->Title}}</td>
                          <td><img src="https://s3.ap-south-1.amazonaws.com/kyrgyzstan/images/{{$row->Image}}" style="width:120px;height:70px;"></td>
                          <td>
                             @if($row->Status == 1)
                          ...
                          <td class="td-actions text-right">
                            ...
                            <button type="submit"  rel="tooltip" class="btn btn-success" style="background-color: #665C7C; padding:10px; padding-left: 20px; box-shadow: none; margin-right: 10px; padding-right: 20px;">
                              Edit
                            </button>
                            </form>
                            <button type="button" rel="tooltip" data-toggle="modal" data-target="#myModal" class="btn btn-danger pull-right" onclick="delete_function('{{$row->id}}')" style="background-color: red; padding:10px; padding-left: 15px; box-shadow: none;  padding-right: 15px;">
                              Delete
                            </button>
                          </td>
                        </tr>
