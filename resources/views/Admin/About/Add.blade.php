                ...
                <div class="card ">
                  ...
                  <div style="background-color: #665C7C; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>
                      ...
                      <a href="{{route('Admin/About')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#665C7C;">Manage</a></h4>
                  </div>
                      ...
                      <div class="col-md-4 col-sm-4">
                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                          <div class="fileinput-new thumbnail"  style="height: 165px;">
                            <img src="@if(isset($edit->id)) https://s3.ap-south-1.amazonaws.com/kyrgyzstan/images/{{$edit->Image}} @else {{url('/')}}/public/assets/img/image_placeholder.jpg @endif" alt="..." height="165px">
                          </div>
