...
<div class="col-sm-6">
<a href="{{route('Admin/StudentCorner/Add')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
</div>
</div>
</div>
    ...
    <table class="table table-striped table-bordered sourced-data">
	        ...
	        @foreach($data as $row)
	            <tr>
	                ...
	                <td>{{$row->Title}}</td>
	                <td>
	                	<img src="{{url('/')}}/public/studentcorner/{{$row->Image}}" style="width: 50px; height: 50px">
	                </td>
	                <td>
	                	@if($row->Status=='1')
	                ...
	                <form action="{{route('Admin/StudentCorner/EditSession')}}" method="post">
	                <td>
	                	{{csrf_field()}}
	                	...
	                	<form action="{{route('Admin/StudentCorner/Delete')}}" method="post">
	                		{{csrf_field()}}
