      ...
      <div class="card" style="min-height: 80vh">
        <div class="card-header" style="background: #262D47; height: 60px">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="{{route('Admin/SubjectStudentCorner')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Subject List</a>
            </div>
          </div>
        </div>
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="needs-validation was-validated" method="post" action="@if(isset($edit->id)) {{route('Admin/SubjectStudentCorner/Update')}} @else {{route('Admin/SubjectStudentCorner/Store')}} @endif" enctype="multipart/form-data">
              {{csrf_field()}}
               @if(isset($edit->id))
