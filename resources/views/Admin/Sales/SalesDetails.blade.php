      ...
      <div class="card" style="min-height: 80vh">
        <div class="card-header" style="background: #262D47; height: 60px">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="{{route('Admin/Sales')}}" style="float: right; margin-top: -10px;" class="btn btn-danger"> List</a>
            </div>
          </div>
        </div>
            ...
            <form class="needs-validation was-validated" method="post"  enctype="multipart/form-data">
              ...
              <div class="form-row" style="margin-top: 30px">
                ...
                <div class="col-md-4 mb-4">
                  ...
                  <input type="text" name="OrderId" disabled class="form-control" id="validationCustom01" placeholder="OrderId" value="@if(isset($data->id)){{$data->OrderId}}@endif" required="">
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                  ...
                  <input type="text" name="PaymentId" disabled class="form-control" id="validationCustom01" placeholder="PaymentId" value="@if(isset($data->id)){{$data->PaymentId}}@endif" required="">
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                  ...
                  <input type="text" name="GrandTotal" disabled class="form-control" id="validationCustom01" placeholder="GrandTotal" value="@if(isset($data->id)){{$data->GrandTotal}}@endif" required="">
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                </div>
