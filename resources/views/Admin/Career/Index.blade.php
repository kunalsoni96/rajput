...
<div class="col-sm-6">
<a href="{{route('Admin/Career/Add')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
</div>
</div>
</div>
...
<div class="table-responsive">
  ...
  @foreach($data as $row)
      <tr>
          ...
          <form action="{{route('Admin/Career/EditSession')}}" method="post">
          <td>
            {{csrf_field()}}
...
swal(
'Success',
'Career Added <b style="color:green;">Successfully </b> button!',
'success'
)
</script>
@endif
...
swal(
'Success',
'Career Updated <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal(
'Success',
'Career Deleted <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal({
title: "Are you sure?", 
text: "You will be delete Career", 
type: "warning",
