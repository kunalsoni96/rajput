      ...
      <div class="card" style="min-height: 80vh">
        <div class="card-header" style="background: #262D47; height: 60px">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="{{route('Admin/Banner/Add')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
            </div>
          </div>
        </div>
			                ...
			                <table class="table table-striped table-bordered sourced-data">
							        ...
							        @foreach($data as $row)
							            <tr>
							                ...
							                <td>{{$row->Title}}</td>
							                <td>
							                	<img src="{{url('/')}}/public/banner/{{$row->Image}}" style="width: 50px; height: 50px">
							                </td>
							                <td>
							                	@if($row->Status=='1')
