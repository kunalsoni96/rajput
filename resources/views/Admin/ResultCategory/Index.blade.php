...
<div class="col-sm-6">
<a href="{{route('Admin/ResultCategory/Add')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
</div>
</div>
</div>
    ...
    <table class="table table-striped table-bordered sourced-data">
	        ...
	        @foreach($data as $row)
	            <tr>
	                ...
	                <form action="{{route('Admin/ResultCategory/EditSession')}}" method="post">
	                <td>
	                	{{csrf_field()}}
...
swal(
'Success',
'ResultCategory Added <b style="color:green;">Successfully </b> button!',
'success'
)
</script>
@endif
...
swal(
'Success',
'ResultCategory Updated <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal(
'Success',
'ResultCategory Deleted <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal({
title: "Are you sure?", 
text: "You will be delete ResultCategory", 
type: "warning",
...
$("#delete").click();
} else if (ResultCategory.dismiss === 'cancel') {
swal(
  'Cancelled',
  'Your stay here :)',
  'error'
