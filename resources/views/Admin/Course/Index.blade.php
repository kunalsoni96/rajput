...
<div class="col-sm-6">
<a href="{{route('Admin/Course/Add')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
</div>
</div>
</div>
...
@foreach($data as $row)
    <tr>
        ...
        <td>{{$row->Subject}}</td>
        <td>
        	<img src="{{url('/')}}/public/course/{{$row->Image}}" style="width: 50px; height: 50px">
        </td>
        <td>
        	@if($row->Status=='1')
        ...
        <form action="{{route('Admin/Course/EditSession')}}" method="post">
        <td>
        	{{csrf_field()}}
...
swal(
'Success',
'Course Added <b style="color:green;">Successfully </b> button!',
'success'
)
</script>
@endif
...
swal(
'Success',
'Course Updated <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal(
'Success',
'Course Deleted <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal({
title: "Are you sure?", 
text: "You will be delete Course", 
type: "warning",
