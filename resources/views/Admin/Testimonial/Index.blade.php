      ...
      <div class="card" style="min-height: 80vh">
        <div class="card-header" style="background: #262D47; height: 60px">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="{{route('Admin/Testimonials/Add')}}" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
            </div>
          </div>
        </div>
            ...
            <div class="table-responsive">
                      ...
                      @foreach($data as $row)
                          <tr>
                              ...
                              <td>
                                <img src="{{url('/')}}/public/testimonial/{{$row->Image}}" style="width: 50px; height: 50px">
                              </td>
                              <td>
                                @if($row->Status=='1')
                              ...
                              <form action="{{route('Admin/Testimonials/EditSession')}}" method="post">
                              <td>
                                {{csrf_field()}}
