...
<div class="d-flex align-items-center mt-2">
    ...
    <div class="reset-btn-box">
        <a class="theme-btn" href="{{route('Pendrive-Course')}}">Reset</a>
    </div>
</div>
</div><!-- end question-overview-filter-item -->
...
<div class="contact-form-action mt-2">
    <form method="get" action="{{route('Pendrive-Course/Search')}}">
        <div class="input-box">
...
<div class="card-content p-4">
    <h3 class="card__title mt-0">
        <a href="{{url('/')}}/Pendrive-Course/{{$row->ProductName}}">{{$row->ProductName}}</a>
    </h3>
