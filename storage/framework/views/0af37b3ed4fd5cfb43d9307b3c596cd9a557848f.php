...
<div class="single-slide-item"  style="background-image: url('<?php echo e(url('/')); ?>/public/banner/<?php echo e($row->MobileImage); ?>');">
<div class="container">
<div class="row">
<div class="col-lg-12">
<div class="section-heading">
...
<div class="section-heading">
<img src="<?php echo e(url('/')); ?>/public/frontend/assets/images/mobile.png" style="width: 100%" alt="Rajput Mobile App" >
<br>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Frontend.layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Frontend/Index.blade.php ENDPATH**/ ?>