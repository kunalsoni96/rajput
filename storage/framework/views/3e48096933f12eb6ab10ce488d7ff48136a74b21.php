<!-- BEGIN: Customizer-->
    <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-xl-block"><a class="customizer-close" href="#"><i class="ft-x font-medium-3"></i></a><a class="customizer-toggle bg-primary box-shadow-3" href="#" id="customizer-toggle-setting"><i class="fa fa-cog" style="color:white"></i></a><div class="customizer-content p-2">
	...
	<div class="cz-bg-image row">
		<div class="col mb-3">
			<img src="<?php echo e(url('/')); ?>/public/assets/app-assets/images/backgrounds/04.jpg" class="rounded sidiebar-bg-img" width="50" height="100" alt="background image">
		</div>
		<div class="col mb-3">
			<img src="<?php echo e(url('/')); ?>/public/assets/app-assets/images/backgrounds/01.jpg" class="rounded sidiebar-bg-img" width="50" height="100" alt="background image">
		</div>
		<div class="col mb-3">
			<img src="<?php echo e(url('/')); ?>/public/assets/app-assets/images/backgrounds/02.jpg" class="rounded sidiebar-bg-img" width="50" height="100" alt="background image">
		</div>
		<div class="col mb-3">
			<img src="<?php echo e(url('/')); ?>/public/assets/app-assets/images/backgrounds/05.jpg" class="rounded sidiebar-bg-img" width="50" height="100" alt="background image">
		</div>
	</div>
...
</div><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Admin/layouts/Theme.blade.php ENDPATH**/ ?>