...
<div class="d-flex align-items-center mt-2">
    ...
    <div class="reset-btn-box">
        <a class="theme-btn" href="<?php echo e(route('Desktop-Course')); ?>">Reset</a>
    </div>
</div>
</div><!-- end question-overview-filter-item -->
...
<div class="contact-form-action mt-2">
    <form method="get" action="<?php echo e(route('Desktop-Course/Search')); ?>">
        <div class="input-box">
            <div class="form-group mb-0">
                <input class="form-control" type="text" name="Name" placeholder="Search courses">
...
<div class="card-content p-4">
    <h3 class="card__title mt-0">
        <a href="<?php echo e(url('/')); ?>/Desktop-Course/<?php echo e($row->ProductName); ?>"><?php echo e($row->ProductName); ?></a>
    </h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Frontend.layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Frontend/DesktopSearch.blade.php ENDPATH**/ ?>