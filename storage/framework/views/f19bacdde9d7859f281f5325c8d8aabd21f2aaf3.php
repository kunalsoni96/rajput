...
<tr>
    ...
    <td>
     <?php echo e($row->PhoneNumber); ?>

    </td>
    <td><?php echo e($row->created_at); ?></td>
    <form action="<?php echo e(route('Admin/Admission/EditSession')); ?>" method="post">
    <td>
      ...
      <form action="<?php echo e(route('Admin/Admission/Delete')); ?>" method="post">
        <?php echo e(csrf_field()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Admin/Admission/Index.blade.php ENDPATH**/ ?>