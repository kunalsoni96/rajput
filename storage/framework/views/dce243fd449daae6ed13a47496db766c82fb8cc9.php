...
<form action="<?php echo e(route('logout')); ?>" method="post"><?php echo e(csrf_field()); ?><button id="logout" style="display: none;"></button></form>
  <script type="text/javascript">
    function logout(){
      document.getElementById("logout").click()
    }
  </script><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Admin/layouts/TopMenu.blade.php ENDPATH**/ ?>