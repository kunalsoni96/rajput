      ...
      <div class="card" style="min-height: 80vh">
        <div class="card-header" style="background: #262D47; height: 60px">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="<?php echo e(route('Admin/Customer/Active')); ?>" style="float: right; margin-top: -10px;" class="btn btn-danger"> List</a>
            </div>
          </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Admin/Sales/CustomerDetails.blade.php ENDPATH**/ ?>