...
<div class="col-sm-6">
<a href="<?php echo e(route('Admin/Images/Add')); ?>" style="float: right; margin-top: -10px;" class="btn btn-danger">Add New</a>
</div>
</div>
</div>
...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        ...
        <td>
        	<img src="<?php echo e(url('/')); ?>/public/gallery/<?php echo e($row->Image); ?>" style="width: 50px; height: 50px">
        </td>
        <td>
        	<?php if($row->Status=='1'): ?>
        ...
        <form action="<?php echo e(route('Admin/Images/EditSession')); ?>" method="post">
        <td>
        	...
        	<form action="<?php echo e(route('Admin/Images/Delete')); ?>" method="post">
        		<?php echo e(csrf_field()); ?>
...
swal(
'Success',
'Images Added <b style="color:green;">Successfully </b> button!',
'success'
)
</script>
<?php endif; ?>
...
swal(
'Success',
'Images Updated <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal(
'Success',
'Images Deleted <b style="color:green;">Successfully </b> button!',
'success'
)
...
swal({
title: "Are you sure?", 
text: "You will be delete Images", 
type: "warning",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Admin/Image/Index.blade.php ENDPATH**/ ?>