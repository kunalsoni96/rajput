...
<div class="card-item card-preview">
    <div class="card-image">
        <a href="course-details.html" class="card__img">
        	<img src="<?php echo e(url('/')); ?>/public/result/<?php echo e($row->Image); ?>" alt=""></a>
       <!--  <div class="card-badge">
            <span class="badge-label">RANK <?php echo e($row->Rank); ?></span>
        </div> -->
    </div><!-- end card-image -->
    <div class="card-content">
        <p class="card__label">
            <span class="card__label-text"><?php echo e($row->TitleandYear); ?></span>
            </a>
        </p>
        <h3 class="card__title">
            <a href="course-details.html"><?php echo e($row->Name); ?></a>
        </h3>
        <p class="card__author">
            <a href="teacher-detail.html"><?php echo e($row->Subject); ?></a>
        </p>
    </div>
</div>
</div>
...
<?php echo $__env->make('Frontend.layouts.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rajput_backup\resources\views/Frontend/Result.blade.php ENDPATH**/ ?>